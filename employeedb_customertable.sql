...
CREATE TABLE `customertable` (
  ...
  `CA.C.No` int NOT NULL,
  PRIMARY KEY (`CNumber`,`CPass`,`CEmail`,`CA.C.No`)
...
INSERT INTO `customertable` VALUES ('Akib',1721111008,'0808','c211008@ugrad.iiuc.ac.bd',800000,8008),('Sajjad',1721111013,'1313','c211013@ugrad.iiuc.ac.bd',9000000,3113);
...
-- Dump completed on 2022-06-25 12:52:32
